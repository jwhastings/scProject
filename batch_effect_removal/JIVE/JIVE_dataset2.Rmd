...
toc()
# JIVE Analysis (Permutation Test): 60470.49 sec elapsed (almost 17 hrs)
...
JIVE_results <- readRDS(file = "data/JIVE_v2_dataset2.rds")
...
JIVE_joint_b3_SCE <- SingleCellExperiment(list(logcounts = t(JIVE_results[["joint"]][[3]])))
colData(JIVE_joint_b3_SCE)$Group <- grp_b3
colData(JIVE_joint_b3_SCE)$BatchNum <- "Batch3"

JIVE_joint_SCE <- cbind(JIVE_joint_b1_SCE, JIVE_joint_b2_SCE, JIVE_joint_b3_SCE)
...
dr1 <- plotReducedDim(JIVE_joint_SCE, dimred = "PCA", color_by = "BatchNum")
dr2 <- plotReducedDim(JIVE_joint_SCE, dimred = "TSNE", color_by = "BatchNum")
dr3 <- plotReducedDim(JIVE_joint_SCE, dimred = "UMAP", color_by = "BatchNum")

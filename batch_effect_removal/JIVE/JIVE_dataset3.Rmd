---
title: "JIVE Integration (Dataset 3)"
...
```{r jive1_summary}
JIVE_results <- readRDS(file = "data/JIVE_v2_dataset3_j10_a15.rds")
...
all_rr %>%
  ...
  mutate(method = "JIVE") %>%
  write_csv(file = "output/JIVE_dataset3_kBET_all.csv")
...
all_asw %>%
  ...
  mutate(Method = "JIVE") %>%
  write_csv(file = "output/JIVE_dataset3_ASW.csv")
```

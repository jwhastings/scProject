...
pvca_plot
ggsave("output/pvca_bacherdata.png", pvca_plot, width = 9, height = 4)
```
...
ggsave("output/tsne_bacherdata.png", all_tsne_plot, width = 9, height = 4)
```
...
ggsave("output/umap_bacherdata.png", all_umap_plot, width = 9, height = 4)
```
...
all_metrics_lot
ggsave("output/metrics_bacherdata.png", all_metrics_lot, width = 9, height = 4)
```

...
JIVE_results <-
  jive_v2(
    jive_data,
    rankJ = 10,
    rankA = rep(15, length(jive_data)),
    method = "given",
    maxiter = 10000,
    CORES = CORES
  )
# JIVE v2 runtime (given): 11953.43 sec elapsed
# JIVE algorithm converged after  2880  iterations.
toc()
...
seurat_final <- Embeddings(seurat_integrated)
```

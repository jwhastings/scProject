...
ggsave("output/pvca_simdata.png", pvca_plot, width = 9, height = 4)
```
...
features <- SelectIntegrationFeatures(object.list = sim_seurat_batch)
```
...
ggsave("output/tsne_simdata.png", all_tsne_plot, width = 9, height = 4)
```
...
ggsave("output/umap_simdata.png", all_umap_plot, width = 9, height = 4)
```
...
all_metrics_lot
ggsave("output/metrics_simdata.png", all_metrics_lot, width = 9, height = 4)
```
